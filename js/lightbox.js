...
(function () {
    ...
    var Lightbox = (function () {
        ...
        Lightbox.prototype.start = function ($link) {
            ...
            function addToAlbum($link) {
                self.album.push({
                    ...
                    thumb: $link.attr('data-thumb') || false
                });
            }
        ...
        Lightbox.prototype.changeImage = function (imageNumber) {
            ...
            preloader.onload = function () {
                ...
                if (self.options.fitImagesInViewport) {
                    ...
                    // If there's a mini gallery, then we need more room for it at the bottom
                    if(self.options.showMiniGallery){
                        maxImageHeight = windowHeight - self.containerTopPadding - self.containerBottomPadding - (self.options.thumbnailHeight + 10) - 120;
                    } else {
        ...
        // Display caption, image number, and closing button. (and mini gallery)
        ...
        // If the images are in a set, attempt to find the thumbnails and add them as a small gallery
        // on in the lb-dataContainer with the album information
        Lightbox.prototype.loadMiniGallery = function (){
            var self = this;
        ...
        Lightbox.prototype.end = function () {
            ...
            this.$lightbox.find('.lb-minigallery').empty();
